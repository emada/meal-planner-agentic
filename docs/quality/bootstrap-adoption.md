...
| Control effectiveness     | Partial | Thirteen of twenty-one mandatory gates have a recorded negative probe; the other eight remain unproven. Per-gate status and `Last proven` dates are in `docs/quality/gates.md` |
