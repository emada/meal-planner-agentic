...
| Control effectiveness     | Partial | Ten of twenty mandatory gates have a recorded negative probe; the other ten remain unproven. Per-gate status and `Last proven` dates are in `docs/quality/gates.md` |
