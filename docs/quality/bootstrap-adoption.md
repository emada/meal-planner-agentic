...
| Control effectiveness     | Partial | Eight of seventeen mandatory gates have a recorded negative probe; the other nine land in S6. Per-gate status and `Last proven` dates are in `docs/quality/gates.md` |
