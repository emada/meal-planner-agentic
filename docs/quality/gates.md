...
| Secret scan, full history           | gitleaks (CI)                                                                                                                                                                                          | CI                                                                                                                                                 | a `ghp_`-shaped token committed in a throwaway clone → `leaks found: 1`, exit 1; clean once reverted. **gitleaks CLI 8.30.1 locally; the `gitleaks-action@v2` wiring is unprobed**               | 2026-08-11  |
