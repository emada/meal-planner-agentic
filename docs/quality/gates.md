...
| Duplication                         | jscpd over `src/`, 60-token minimum                                                                                         | CI                                                                                                                                                 | **none recorded** — 0 clones today, so there is nothing to probe against yet               | —           |
