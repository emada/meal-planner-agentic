...
| Browser journeys, mobile + desktop  | Playwright, `desktop-chromium` and `mobile-chromium`                                                                                                                                                   | CI                                                                                                                                                 | browse skipped its detail lookup and opened the modal on partial data → 6 journeys failed across both projects; the spec's 20 runs at that commit passed once reverted | 2026-08-11  |
