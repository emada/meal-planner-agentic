...
| Reflow at 320px (WCAG 1.4.10)       | Playwright `reflow-320` project over five journeys                                                                                                                                                                                                                                                                     | CI                                                                                                                                                 | `overflow-wrap: anywhere` removed from `.card__title` → 3 of 5 journeys failed on a clipped title; 5/5 pass once restored                                                                                                       | 2026-08-11  |
...
- **It records that gates ran and what they returned, not that they work.** A passing run over an ineffective gate is still a failing control. Effectiveness is the negative-probe cycle above, and every one of the twenty-one gates has now been made to reject.
