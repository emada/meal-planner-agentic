...
| A10 | A count was bound to a copy of itself: two documents were asserted to agree on how many gates are proven at the tool, and neither was read from the table holding the fact. Closing the gap would have left both false and the suite green — and the comment beside it called both counts derived. | review                               | derived from the probe cells, and every wording of the other count checked wherever it is written | `governance-consistency.test.ts`, probed by closing the row and by opening a second                     | promoted | `02-quality/06-claim-accuracy.md`        |
