...
|                                                                                    |                                                                                                                              |
| ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| One gate is proven at the tool, not at the gate                                    | CI runs `gitleaks-action`; the probe ran the gitleaks CLI. Closing it means pushing a credential-shaped string to the remote |
...
| No accessibility audit by a practitioner, and no screen-reader testing             | three AA criteria remain unverified; `docs/quality/accessibility.md` names them. The human accepted this state on 2026-08-12 |
...
our own, meal scheduling by day or week, nutrition data, portion scaling, pantry
tracking, recipe creation or rating, offline support, analytics, and any unit
arithmetic on measures. All are `SPEC.md` non-goals.
